                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <button class="btn btn-success"><a
                                                        href="cbt_session.php?sessionid=<?php echo $row['session_id'];?>" class="text-white">Resume</a></button>
                                            </td>
                                            ...
                                            <td>
                                                <button class="btn btn-default"><a
                                                        href="cbt_report_summary.php?sessionid=<?php echo $row['session_id'];?>" class="text-dark">Details</a></button>
                                            </td>
                                            <?php
                                                }
                                            ?>
