...
if(isset($_SESSION['user_data'])){
	...
	$data=array();
	$qr=mysqli_query($con,"select * from new_user_requests where approved = 0;");
...
<body>
    ...
    <nav class="navbar navbar-expand-md bg-white navbar-light">
        ...
        <div class="collapse navbar-collapse" id="collapsibleNavbar">
            <ul class="navbar-nav">
                <li class="nav-item">
                    <a class="nav-link" href="teacher_home.php" style="font-size: 17px">Therapists</a>
                </li>
                <li class="nav-item">
                    <a class="nav-link active" href="list_requests.php" style="font-size: 17px">Requests</a>
                </li>
            </ul>
        </div>
        ...
        <div class="row">
            <div class="col-lg-12">
                <div>
				 ...
				 ?>
                        <tr style="">
                            <td><?php echo $d['user_request_id']; ?></td>
                            ...
                            <td><a class="btn btn-success"
                                    href="allow_request.php?id=<?php echo $d['user_request_id']; ?>"><i
                                        class="fa fa-check"></i></a></td>
                            <!--detail button below-->
                            <td><a class="btn btn-danger" style="background-color: #9c54a8  !important"
                                    href="profile.php?id=<?php echo $d['user_request_id']; ?>"><i
